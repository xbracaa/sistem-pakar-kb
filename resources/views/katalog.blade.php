...
<body class="bg-brand-bg text-brand-dark antialiased overflow-x-hidden font-sans pb-10">
    ...
    <main x-data="{ activeFilter: 'Semua' }" class="max-w-7xl mx-auto px-6 pt-10 pb-24">
        ...
        @php
            ...
            $infoKb = [
                'M01' => [
                    'tipe' => 'Non Hormonal', 'subtitle' => 'ALAT KONTRASEPSI DALAM RAHIM',
                ...
                'M02' => [
                    'tipe' => 'Hormonal', 'subtitle' => 'IUD LEVONORGESTREL',
                ...
                'M03' => [
                    'tipe' => 'Hormonal', 'subtitle' => 'DMPA / DEPO PROVERA',
                ...
                'M04' => [
                    'tipe' => 'Hormonal', 'subtitle' => 'DEPO-ESTROGEN SIKLOFENAT',
                ...
                'M05' => [
                    'tipe' => 'Hormonal', 'subtitle' => 'ESTROGEN + PROGESTERON',
                ...
                'M06' => [
                    'tipe' => 'Hormonal', 'subtitle' => 'MINI-PIL / PROGESTERON ONLY',
                ...
                'M07' => [
                    'tipe' => 'Hormonal', 'subtitle' => 'BATANG SUBDERMAL HORMONAL',
                ...
                'M08' => [
                    'tipe' => 'Non Hormonal', 'subtitle' => 'METODE BARIER PRIA (KONDOM)',
                ...
                'M09' => [
                    'tipe' => 'Hormonal', 'subtitle' => 'KOYO KONTRASEPSI',
                    'deskripsi' => 'Koyo yang ditempel di kulit untuk melepaskan hormon pencegah kehamilan secara berkala.',
                    'plus' => ['Praktis penggunaannya', 'Dosis hormon stabil'],
                    'minus' => ['Bisa terlepas atau iritasi', 'Kurang efektif untuk wanita obesitas']
                ],
                'M10' => [
                    'tipe' => 'Hormonal', 'subtitle' => 'CINCIN VAGINA',
                    'deskripsi' => 'Cincin fleksibel yang dimasukkan ke vagina untuk melepaskan hormon pencegah ovulasi.',
                    'plus' => ['Satu cincin untuk 3 minggu', 'Dosis hormon lebih rendah'],
                    'minus' => ['Bisa terasa mengganjal', 'Risiko infeksi jika tidak higienis']
                ],
                'M12' => [
                    'tipe' => 'Permanen', 'subtitle' => 'STERILISASI WANITA (TUBEKTOMI)',
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            @foreach($metode as $m)
                @if(!in_array($m->id, ['M01', 'M02', 'M03', 'M04', 'M05', 'M06', 'M07', 'M08', 'M09', 'M10', 'M12']))
                    @continue
                @endif
                @php
                    // Fallback aman jika data metode baru tidak ada di array
                    $info = $infoKb[$m->id] ?? [
                        'tipe' => 'Lainnya', 'subtitle' => 'METODE KONTRASEPSI',
