...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
    <a href="{{ route('admin.kondisi.index') }}" class="bg-gradient-to-br from-white to-[#F5F8F6] rounded-3xl p-8 border border-white shadow-lg shadow-brand-dark/5 flex items-center justify-between transform transition-transform hover:-translate-y-1">
        <div>
    ...
    <a href="{{ route('admin.metode.index') }}" class="bg-gradient-to-br from-white to-[#F5F8F6] rounded-3xl p-8 border border-white shadow-lg shadow-brand-dark/5 flex items-center justify-between transform transition-transform hover:-translate-y-1">
        <div>
    ...
    <a href="{{ route('admin.aturan.index') }}" class="bg-gradient-to-br from-white to-[#F5F8F6] rounded-3xl p-8 border border-white shadow-lg shadow-brand-dark/5 flex items-center justify-between transform transition-transform hover:-translate-y-1">
        <div>
